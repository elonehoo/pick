...
<template>
  <div>
    ...
    <div>
      <pick-row class="row border-bottom" :w="12">
        <pick-col class="background border-left" type="flex" justify="center" align="center" lg="2" sm="4" xs="12">vs-lg="2" vs-sm="4" vs-xs="12"</pick-col>
        <pick-col class="background border-left" type="flex" justify="center" align="center" lg="8" sm="4" xs="12">vs-lg="8" vs-sm="4" vs-xs="12"</pick-col>
        <pick-col class="background border-left border-right" type="flex" justify="center" align="center" lg="2" sm="4" xs="12">vs-lg="2" vs-sm="4" vs-xs="12"</pick-col>
      </pick-row>
    </div>
</div>
</template>
